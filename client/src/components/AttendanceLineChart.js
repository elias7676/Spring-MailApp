...
export default function AttendanceChart({data,key1,key2}) {
  return (
    <div style={{"width":"55%"}}>
      ...
      <div className="section col-md-6" >
        <h3 DonutChartclassName="section-title" style={{"padding-top":"0px","padding-left":"140px"}}>Number of Absent Students & teachers</h3>
